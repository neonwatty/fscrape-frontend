...
test.describe('Posts Explorer E2E Tests', () => {
  ...
  test('should load the posts explorer page', async ({ page }) => {
    ...
    const pageHeader = page
      .locator('h1:has-text("Posts"), h1:has-text("Explorer"), [data-testid="page-title"]')
      .first()
    await expect(pageHeader).toBeVisible({ timeout: 10000 })

    // Check for posts table or list
    const postsContainer = page
      .locator('table, [data-testid="posts-list"], .posts-grid, [role="grid"]')
      .first()
  ...
  test('should have working filters', async ({ page }) => {
    ...
    const platformFilter = page
      .locator('select:has(option), button:has-text("Platform"), [data-testid="platform-filter"]')
      .first()
    ...
    const dateFilter = page
      .locator('button:has-text("Date"), button:has-text("Time"), [data-testid="date-filter"]')
      .first()
  ...
  test('should handle sorting', async ({ page }) => {
    ...
    const scoreHeader = page
      .locator('th:has-text("Score"), button:has-text("Score"), [data-testid="sort-score"]')
      .first()
  ...
  test('should handle pagination', async ({ page }) => {
    ...
    const prevButton = page
      .locator('button:has-text("Previous"), a:has-text("Previous"), [aria-label="Previous page"]')
      .first()
  ...
  test('should open post details', async ({ page }) => {
    ...
    const firstPostLink = page
      .locator('a[href*="reddit.com"], a[href*="ycombinator.com"], [data-testid="post-link"]')
      .first()
